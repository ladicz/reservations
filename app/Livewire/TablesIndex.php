...
class TablesIndex extends Component
{
    ...
    /**
     * Handler of change on class property startDate. Loads available tables.
     */
    ...
    /**
     * Creates array of input time strings (hh:mm) as reservation times for selectbox.
     *
     * @param string $beginTime First reservation time.
     * @param string $endTime Last reservation time.
